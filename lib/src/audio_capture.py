"""
Audio capture module for hyprchrp
...
class AudioCapture:
                ...
                try:
                    ...
                    if device_info['max_input_channels'] > 0:
                        ...
                        print(
                            ...
                            f"{device_info['name']} (ID: {self.preferred_device_id})"
                        )
                    else:
                        print(
                            "⚠ Configured device "
                            f"{self.preferred_device_id} has no input channels, using default"
                        )
                        self.preferred_device_id = None
                except Exception as e:
                    print(
                        "⚠ Configured audio device "
                        f"{self.preferred_device_id} not available: {e}"
                    )
                    self.preferred_device_id = None
    ...
    def _record_audio(self):
        ...
        try:
            ...
            device_to_use = self.preferred_device_id
